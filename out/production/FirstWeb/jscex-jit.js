(function () {
    var codeGenerator = (typeof eval("(function () {})") == "function") ? function (code) {
        return code;
    } : function (code) {
        return "false || " + code;
    };
    var stringify = (typeof JSON !== "undefined" && JSON.stringify) ? function (s) {
            ...
            _write: function (s) {
                ...
                "delay": function (ast) {
                    ...
                    if (info.assignee == "return") {
                        ...
                        if (info.assignee) {
                            this._writeIndents()._visitRaw(info.assignee)._writeLine(" = " + info.argName + ";");
                        }
                        this._visitJscexStatements(ast.stmts);
                    }
                    this._indentLevel--;
                    ...
                    if (ast.elseStmts) {
                        ...
                        this._writeIndents()._writeLine("return " + this._builderVar + ".Normal();");
                    }
                    this._indentLevel--;
                    this._writeIndents()._write("}");
                }, "switch": function (ast) {
                    ...
                    for (var i = 0; i < ast.caseStmts.length; i++) {
                        ...
                        if (caseStmt.item) {
                            this._writeIndents()._write("case ")._visitRaw(caseStmt.item)._writeLine(":");
                        } else {
